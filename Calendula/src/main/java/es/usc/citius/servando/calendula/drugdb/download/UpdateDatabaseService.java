...
public class UpdateDatabaseService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (database != null && database.equals(PreferenceUtils.instance().preferences().getString(PreferenceKeys.DRUGDB_CURRENT_DB.key(), null)) && DBVersionManager.checkForUpdate(ctx) != null) {
