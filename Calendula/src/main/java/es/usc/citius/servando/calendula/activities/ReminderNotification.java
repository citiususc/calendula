...
public class ReminderNotification {
    ...
    public static void notify(final Context context, final String title, Routine r, List<ScheduleItem> doses, Intent intent)
    {
        ...
        notify(context,title,intents,intent, options);
    }
    ...
    private static void notify(final Context context, final String title,
        ...
        PendingIntent defaultIntent = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
        PendingIntent delayIntent = PendingIntent.getActivity(context, 1, actionIntents.first, PendingIntent.FLAG_CANCEL_CURRENT);
        PendingIntent cancelIntent = PendingIntent.getBroadcast(context, 2, actionIntents.second, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private static Notification buildNotification(Context context, NotificationOptions options){
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setContentText(options.text).setAutoCancel(true)
