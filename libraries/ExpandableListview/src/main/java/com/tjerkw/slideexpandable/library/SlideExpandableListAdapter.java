...
public class SlideExpandableListAdapter extends AbstractSlideExpandableListAdapter {
    ...
    public SlideExpandableListAdapter(ListAdapter wrapped, int toggle_button_id, int expandable_view_id, int lastOpen) {
        super(wrapped, lastOpen);
    ...
    public SlideExpandableListAdapter(ListAdapter wrapped) {
        this(wrapped, R.id.expandable_toggle_button, R.id.expandable, -1);
    }
