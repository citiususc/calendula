...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.bpSwitchStyle);
    }
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mThumbDrawable = a.getDrawable(R.styleable.Switch_bpThumb);
        mTrackDrawable = a.getDrawable(R.styleable.Switch_bpTrack);
        mTextOn = a.getText(R.styleable.Switch_bpTextOn);
        mTextOff = a.getText(R.styleable.Switch_bpTextOff);
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.Switch_bpThumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_bpSwitchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.Switch_bpSwitchPadding, 0);

        final int appearance = a.getResourceId(R.styleable.Switch_bpSwitchTextAppearance, 0);
        if (appearance != 0) {
